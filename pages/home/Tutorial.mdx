...
For the complete contract code, please see [[hilo]](https://github.com/Manta-Network/zkShuffle-docs/zkShuffle/blob/main/packages/contracts/contracts/games/hilo/Hilo.sol).
...
For the complete end-to-end test, please see [[e2e]](https://github.com/Manta-Network/zkShuffle-docs/zkShuffle/blob/main/packages/contracts/tests/e2e.ts).
